namespace ChessLogic
{
    public class Castle : Move
    {
        ...
        public override bool Execute(Board board)
        {
            ...
            return false; // Рокировка не сбрасывает 50 ходов (не пешка, не взятие)
        }
        ...
        public override bool IsLegal(Board board)
        {
            ...
            Position kingCurrentPos = FromPos; 

            for (int i = 0; i < 2; i++)
            {
                Position nextPos = kingCurrentPos + kingMoveDir;
                new NormalMove(kingCurrentPos, nextPos).Execute(copy);
                kingCurrentPos = nextPos; 
